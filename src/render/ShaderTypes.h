...
extern const unsigned TEXTURE_PREFILTER_MAP_UNIT;
extern const int      TEXTURE_PREFILTER_MAP_INDEX;
extern const unsigned TEXTURE_BRDF_LUT_UNIT;
extern const int      TEXTURE_BRDF_LUT_INDEX;
