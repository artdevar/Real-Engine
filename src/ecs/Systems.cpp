      ...
      for (TModelComponent::TPrimitiveData &Primitive : ModelComponent.Primitives)
      {
        if (Primitive.MaterialIndex >= 0 && Primitive.MaterialIndex < ModelComponent.Materials.size())
        {
          ...
          if (Material.BaseColorTexture)
          {
            ...
            Shader->SetUniform("u_Material.BaseColorTexture", TextureUnit);
            ++TextureUnit;
          }
          ...
          if (Material.MetallicRoughnessTexture)
          {
            ...
            Shader->SetUniform("u_Material.RoughnessTexture", TextureUnit);
            ++TextureUnit;
          }

          Shader->SetUniform("u_Material.BaseColorFactor", Material.BaseColorFactor);
          Shader->SetUniform("u_Material.MetallicFactor", Material.MetallicFactor);
          Shader->SetUniform("u_Material.RoughnessFactor", Material.RoughnessFactor);
        }
