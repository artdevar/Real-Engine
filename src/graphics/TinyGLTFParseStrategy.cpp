...
void CTinyGLTFParseStrategy::ParseAttributes(const tinygltf::Model     &_Source,
                                             const tinygltf::Primitive &_SourcePrimitive,
                                             TPrimitive                &_TargetPrimitive)
{
...
void CTinyGLTFParseStrategy::GenerateTangentsIfMissing(TPrimitive &Primitive)
{
  ...
  iface.m_setTSpace = [](const SMikkTSpaceContext *ctx, const float fvTangent[], const float fvBiTangent[], const float, const float, const tbool,
